...
const allBrainParts = [
  ...
  { name: 'Wernicke\'s Area', color: '#7E0006', description: 'Important for language comprehension and understanding. Located in the left temporal lobe.' },
  { name: 'Corpus Callosum', color: '#124E0C', description: 'Connects the left and right hemispheres, facilitating communication.' },
  { name: 'Amygdala', color: '#614A27', description: 'Processes emotions, especially fear and aggression.' },
  ...
  { name: 'Pons', color: '#121277', description: 'Regulates breathing and sleep.' },
  ...
  { name: 'Pituitary Gland', color: '#E7E000', description: 'The "master gland" that regulates hormones in the body.' },
];
